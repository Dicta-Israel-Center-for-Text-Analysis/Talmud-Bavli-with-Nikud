...
תלמוד בבלי המנוקד, הוא מיזם שהתאפשר הודות לנקדן הרבני שלנו מבית דיקטה. הנקדן הרבני הינו נקדן אוטומטי שמתחשב בכללי הניקוד הייחודיים לטקסטים רבניים מוקדמים ומאוחרים.

מסכת ברכות נוקדה במלואה בנקדן הרבני. על הניקוד האוטומטי עברו מנקדים מקצועיים וערכו את הניקוד במידת הצורך, בעזרת הנקדן. אחר כך המשכנו עם מסכתות שבת, עירובין, פסחים, יומא ושאר המסכתות שבסדר מועד (ומסכתות נוספות). המסכתות המנוקדות מופצות לתועלת הציבור, ללא כל מטרת רווח.
